...
const CardPage = () => {
  ...
  <div className="shopping-cart">
    <div className="cart-main">
      ...
      <div className="product">
        <img className="image"  src="images\photo cart.png"/>
  ...
  <section className="cart-button">
    ...
    <svg id="quarantee" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-patch-check" viewBox="0 0 16 16">
    ...
    <svg id="shipping" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-gift" viewBox="0 0 16 16">
    ...
    <div>
      ...
      <svg id="support" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-telephone" viewBox="0 0 16 16">
