  ...
  <div class="shopping-cart">
    <div class="cart-main">
      <div class="column-labels">
        <ul class="product-cart">
          ...
          <li class="product-line-price">Subtotal</li>
          </ul>
      </div>

      <div class="product">
        <img class="image"  src="images\photo cart.png"/>
        <div class="product-details">
          <p class="name">Sofa</p>
          <p class="price">250,000.00</p>
          <p class="quantity"/>
          <input type="number" value="1" min="1"/>
          <p class="line-price">250,000.00</p>
          <p class="removal"> 
    ...
    <div class="totals">
        ...
        <div class="subtotal-details">
          ...
          <p class="subtotal-value" >250,000.00</p>
        </div>
        <div class="total-details">
          <p class="total">Total</p>
          <p class="total-value">250,000.00</p>
        </div>
